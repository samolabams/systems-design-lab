...
also starts the queue/worker path from [async queues](/modules/async-queues/).
...
([apps/url-shortener/src/tracing.js](https://github.com/samolabams/systems-design-lab/blob/main/apps/url-shortener/src/tracing.js) and
[apps/worker/src/tracing.js](https://github.com/samolabams/systems-design-lab/blob/main/apps/worker/src/tracing.js)); this profile
...
- [Availability](/modules/availability/) for reliability targets.
- [Circuit breakers](/modules/circuit-breakers/) for failure signals.
- [Async queues](/modules/async-queues/) for observing background work.
