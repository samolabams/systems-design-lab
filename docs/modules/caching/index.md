...
The helper code lives in [apps/url-shortener/src/cache.js](https://github.com/samolabams/systems-design-lab/blob/main/apps/url-shortener/src/cache.js).
...
- [Edge caching](/modules/edge-caching/) for caching closer to users.
- [Databases](/modules/databases/) for the source-of-truth role.
