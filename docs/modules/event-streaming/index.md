...
**Track:** Components
**Prerequisites:** [Async queues](/modules/async-queues/)
...
- [Message delivery semantics](/modules/message-delivery-semantics/) for duplicates and idempotency.
- [Sagas](/modules/sagas/) for event-driven workflows.
- [Observability](/modules/observability/) for watching event pipelines.
