...
This module covers the queue model. [Event streaming](/modules/event-streaming/)
...
- [Message delivery semantics](/modules/message-delivery-semantics/) for duplicates, retries, and idempotency.
- [Sagas](/modules/sagas/) for multi-step workflows.
- [Observability](/modules/observability/) for measuring queues and workers.
