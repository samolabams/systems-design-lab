...
- [API gateway](/modules/api-gateway/) for where APIs enter the system.
- [Rate limiting](/modules/rate-limiting/) for protecting public APIs.
- [Observability](/modules/observability/) for measuring API behavior.
