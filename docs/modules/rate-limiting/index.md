...
- [Distributed rate limiter](/modules/distributed-rate-limiter/) for a full-system design.
- [Circuit breakers](/modules/circuit-breakers/) for downstream failure protection.
