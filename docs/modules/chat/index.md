...
[Async queues](/modules/async-queues/), [Event streaming](/modules/event-streaming/),
[Message delivery semantics](/modules/message-delivery-semantics/), and
[Observability](/modules/observability/). They provide the vocabulary this
capstone expects.
...
- **Fan-out & queues** — route a message to all participants' connections, possibly
  across nodes, via [async queues](/modules/async-queues/) / pub-sub.
...
- [Event streaming](/modules/event-streaming/) for replayable message logs.
- [Message delivery semantics](/modules/message-delivery-semantics/) for duplicates and retries.
- [Observability](/modules/observability/) for operational signals in real-time systems.

## Further reading

- Alex Xu, *System Design Interview*, ch. "Design a Chat System".
- Referenced modules: [async queues](/modules/async-queues/),
  [message delivery semantics](/modules/message-delivery-semantics/).
