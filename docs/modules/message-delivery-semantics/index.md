...
**Prerequisites:** [Event streaming](/modules/event-streaming/)
...
are covered by [leader election and replica sets](/modules/leader-election-replica-sets/)
and [consistency models](/modules/consistency-models/).
...
- [Asynchronous queues](/modules/async-queues/) for basic background work.
- [Event streaming](/modules/event-streaming/) for replayable logs.
- [Sagas](/modules/sagas/) for multi-step distributed workflows.
