...
4. **Core components** - pick building blocks and *justify each* (use the
   [component-selection](/modules/component-selection/) catalog to choose
...
- [Estimation](/modules/estimation/) for sizing requirements.
- [Component selection](/modules/component-selection/) for choosing mechanisms.
- [TinyURL](/modules/tinyurl/) for applying the method to a full design.
