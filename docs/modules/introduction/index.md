...
- [Estimation](/modules/estimation/) for adding numbers to trade-offs.
- [Consistency models](/modules/consistency-models/) for a common distributed trade-off.
- [The design method](/modules/design-method/) for applying the vocabulary.
