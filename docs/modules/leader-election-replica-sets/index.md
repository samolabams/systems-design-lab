...
[Replication and failover](/modules/replication-failover/) shows manual
...
[`init-replica.sh`](https://github.com/samolabams/systems-design-lab/blob/main/infra/database/mongo/init-replica.sh). It waits for the
...
3. Compare automatic election here with the manual `pg_promote()` drill in
   [Replication and failover](/modules/replication-failover/).
...
- [Replication and failover](/modules/replication-failover/) for database failover behavior.
- [Consistency models](/modules/consistency-models/) for stale reads and quorum reasoning.
- [Availability](/modules/availability/) for the reliability impact of redundancy.
