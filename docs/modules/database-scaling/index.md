...
**Track:** Components
**Prerequisites:** [Databases](/modules/databases/)
...
[scaling](/modules/scaling/). This module narrows that map to the data tier.
...
| Concept | Lab proof |
|---|---|
| database fundamentals | [Databases](/modules/databases/) |
| read replicas, lag, manual failover | [Replication and failover](/modules/replication-failover/) |
| automatic leader election and quorum | [Leader election and replica sets](/modules/leader-election-replica-sets/) |
| partitioning, shard movement, rebalancing | [Partitioning and sharding](/modules/partitioning-sharding/) |
| cache read offload and staleness | [Caching](/modules/caching/) |
| queue write smoothing and backpressure | [Async queues](/modules/async-queues/) |
| measuring bottlenecks | [Observability](/modules/observability/) |
| when not to add machinery | [When not to scale](/modules/when-not-to-scale/) |
...
- [Databases](/modules/databases/) for the basic data-store role.
- [Replication and failover](/modules/replication-failover/) for read replicas and promotion.
- [Partitioning and sharding](/modules/partitioning-sharding/) for splitting data by key.
