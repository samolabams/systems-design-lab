...
[Event streaming](/modules/event-streaming/), [Database scaling](/modules/database-scaling/),
...
- **Caching** — precomputed feeds live in [caching](/modules/caching/) for
  fast reads.
- **Sharding** — the post/feed store is partitioned with
  [Partitioning and sharding](/modules/partitioning-sharding/); hot shards must be considered.
...
- [Caching](/modules/caching/) for hot timelines.
- [Event streaming](/modules/event-streaming/) for feed update pipelines.
- [Database scaling](/modules/database-scaling/) for storage and query pressure.
...
- "Fanout on write vs read" — high-scalability discussions of Twitter/Instagram
  feeds.
- Referenced modules: [caching](/modules/caching/),
