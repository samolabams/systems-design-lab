...
- [DNS](/modules/dns/) for name resolution foundations.
- [Load balancing](/modules/load-balancing/) for choosing among healthy replicas.
- [API gateway](/modules/api-gateway/) for public entry points.
