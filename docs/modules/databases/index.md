...
- [Database scaling](/modules/database-scaling/) for pressure and growth paths.
- [Replication and failover](/modules/replication-failover/) for availability and stale reads.
- [Object storage](/modules/object-storage/) for large opaque bytes.
