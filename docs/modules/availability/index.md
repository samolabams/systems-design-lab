...
- [Replication and failover](/modules/replication-failover/) for a concrete availability mechanism.
- [Multi-region, DR and backups](/modules/multi-region-dr/) for recovery planning.
- [Observability](/modules/observability/) for measuring reliability signals.
