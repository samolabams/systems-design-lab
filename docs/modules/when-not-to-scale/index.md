...
- [Estimation](/modules/estimation/) for sizing the problem.
- [Component selection](/modules/component-selection/) for choosing a justified mechanism.
- [Scaling](/modules/scaling/) for when the evidence does support scaling.
