...
step "Hammer the same code 50x" "all hits â€” the DB is not touched"
...
note "TTL counts down to expiry (CACHE_TTL, default 60s) â€” bounded staleness."
pause
...
step "Redis stats â€” origin offload" "keyspace_hits dominate; the DB is spared"
