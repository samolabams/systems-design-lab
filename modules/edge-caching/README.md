...
- [Caching](../caching/README.md) for application-side cache patterns.
- [Object storage](../object-storage/README.md) for blob origins.
- [DNS](../dns/README.md) for how clients find edge entry points.
