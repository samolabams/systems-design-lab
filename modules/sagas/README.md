...
transactional outbox from [message delivery semantics](../message-delivery-semantics/README.md)
...
- [Message delivery semantics](../message-delivery-semantics/README.md) for retries and idempotency.
- [Event streaming](../event-streaming/README.md) for choreography foundations.
- [Async queues](../async-queues/README.md) for background step execution.
