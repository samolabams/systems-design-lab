...
[Rate limiting](../rate-limiting/README.md), [Caching](../caching/README.md),
...
- **Sharding & hot keys** — partition counters by key
  ([partitioning and sharding](../partitioning-sharding/README.md)); a single very *hot key* (one key taking a
...
- [Rate limiting](../rate-limiting/README.md) for the runnable local mechanism.
- [Caching](../caching/README.md) for shared fast state trade-offs.
...
- Referenced modules: [rate limiting](../rate-limiting/README.md),
