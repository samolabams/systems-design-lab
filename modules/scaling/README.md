...
replicas. [Database scaling](../database-scaling/README.md) applies the
...
|---|---|---|
| [Makefile](../../Makefile) | Defines `make scale` and `make health-loop` | `docker compose up -d --scale app=$(N)` |
...
- [Load balancing](../load-balancing/README.md) for distributing traffic across replicas.
- [Database scaling](../database-scaling/README.md) for shared dependency pressure.
- [When not to scale](../when-not-to-scale/README.md) for avoiding unnecessary scale work.
